...
Ver `.github/libs/ai-models.md` (LLMs de assistência ao desenvolvimento — **não** confundir com o classificador NLP do produto).
...
- **AI Models (assistants):** `.github/libs/ai-models.md`
- **Documentation:** `.github/rules/documentation-rules.md`
